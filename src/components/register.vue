      ...
      <div class = right>
        <el-form ref = "form" :model = "form" :rules="rules" label-width="50px" class="ruleForm">
          ...
          <el-form-item label="Area" prop="region">
            <el-select v-model="form.region" placeholder="Country/Region">
              <el-option v-for="item in options" :key="item.value" :label="`${item.short} +${item.tel}`" :value="item.tel">
              </el-option>
            </el-select>
          </el-form-item>
    ...
    return {
      ...
      rules: {
        name: [
          ...
          { min: 8, max: 20, message: 'Length should between 8-20 characters', trigger: 'blur' }
        ],
        region: [
          { required: true, message: 'Please choose the register region', trigger: 'change' }
        ],
        email: [
          { type: 'email', required: true, message: 'Please input right email format ', trigger: 'change' }
        ],
        telephone: [
          { required: true }
        ],
        ...
        type: [
          { required: true, message: 'Please input your identity', trigger: 'change' }
        ]
